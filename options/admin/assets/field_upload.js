...
jQuery(document).ready(function(){
            ...
            jQuery(".atf-options-upload").click( function( event ) {
                ...
                custom_file_frame.on( "select", function() {
                    ...
                    jQuery('.atf-options-upload',activeFileUploadContext).hide();
                    jQuery('.atf-options-upload-screenshot',activeFileUploadContext).show();
                    jQuery('.atf-options-upload-remove',activeFileUploadContext).show();
            });

            custom_file_frame.open();
        });

    jQuery(".atf-options-upload-remove").click( function( event ) {
        var activeFileUploadContext = jQuery(this).parent();
        var relid = jQuery(this).attr('rel-id');
        ...
        jQuery('.atf-options-upload-screenshot',activeFileUploadContext).fadeOut('slow');
